(function(require) {
    ...
    (function() {
        var config = {
            map: {
                "*": {
                    'Magento_Checkout/template/authentication.html': 'Magenest_Core/template/authentication.html',
                    'AjaxCart': 'Magenest_Core/js/cartValueIncDec',
                    'CartQtyUpdate': 'Magenest_Core/js/cartQtyUpdate'
                }
            },
            shim: {
                AjaxCart: {
    ...
    (function() {
        var config = {
            map: {
                '*': {
                    'Magento_SalesRule/template/payment/discount.html': 'Magenest_CouponCode/template/payment/discount.html'
                }
            }
        };
        require.config(config);
            ...
            config: {
                mixins: {
                    'Magento_ProductVideo/js/load-player': {
                        'Magenest_CustomUploadGallery/js/load-player-mixin': true
                    },
                    'Magento_ProductVideo/js/fotorama-add-video-events': {
                        'Magenest_CustomUploadGallery/js/fotorama-add-video-events-mixin': true
                    }
                }
            }
        };
    ...
    (function() {
        var config = {
            config: {
                mixins: {
                    'mage/validation': {
                        'Magenest_Customer/js/validation-mixin': true
                    }
                }
            }
        }
    ...
    (function() {
        var config = {
            'map': {
                '*': {
                    'directoryFieldUpdater': 'Magenest_Customer/js/field-updater.js'
                }
            },
            config: {
                mixins: {
    ...
    (function() {
        var config = {
            paths: {
                'countdown-js': "Magenest_Widget/js/lib/jquery.countdown"
            },
            shim: {
                'countdown-js': {
                    deps: ['jquery']
        ...
        var config = {
            ...
            map: {
                '*': {
                    ...
                    defaultAddressAction: 'Magenest_Directory/js/defaultAddressAction',
                }
            }
        };
        require.config(config);
    ...
    (function() {
        var config = {
            config: {
                mixins: {
                    'Magento_Customer/js/customer-data': {
                        'Magenest_LSCustomer/js/view/customer-data-mixin': true
                    }
                }
            }
        };
    ...
    (function() {
        var config = {
            map: {
                'megamenuOwlCarousel': 'Magenest_MegaMenu/owl-carousel/owl.carousel'
            },
            shim: {
    ...
    (function() {
        var config = {
            config: {
                mixins: {
                    'mage/validation': {
                        'Magenest_OrderManagement/js/validation-mixin': true
                    }
                }
            }
        }
        ...
        var config = {
            map: {
                '*': {
                    ...
                    validateMethod: "Magenest_SocialLogin/js/validation/custom-validate"
                }
            },
            shim: {
                magnificPopup: {
    ...
    (function() {
        var config = {
            config: {
                mixins: {
                    'Magento_Ui/js/lib/validation/validator': {
                        'Magento_Checkout/js/validator/telephone-with-prefix': true
                    }
                }
            }
        }
    ...
    (function() {
        var config = {
            config: {
                mixins: {
                    'mage/validation': {
                        'Magento_Review/js/validation-mixin': true
                    }
                }
            }
        }
